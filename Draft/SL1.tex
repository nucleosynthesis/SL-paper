...
\begin{figure}%[hbt!]
\centering
\includegraphics[width=0.45\textwidth]{figures/corr-3-9}
\includegraphics[width=0.45\textwidth]{figures/corr-3-61}\\
\includegraphics[width=0.45\textwidth]{figures/corr-3-85}
\includegraphics[width=0.45\textwidth]{figures/corr-61-85}
\caption{2D distributions of $\hat{n}_{I}$ against $\hat{n}_{J}$ for
  %$I=4,J=62$ (left), $I=1,J=86$ (center) and $I=62,J=86$ (right)
  $I=4,J=10$ (top left), $I=4,J=62$ (top right), $I=4,J=86$ (bottom left), and
