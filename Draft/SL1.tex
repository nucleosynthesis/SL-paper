...
the likelihood attains it maximum for a given set of $n^{\rm{obs}_I}$. \fxfatal{Note, here I am using L to mean the whole thing but in Eqn 1 we refer to L as only part of the likelihood, i.e we
need to multiply by pi(d). I wonder if it makes sense to define $L_{\rm{simp}}$ as the production of these things and make it a function of the thetas ?}
