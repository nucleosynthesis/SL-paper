...
In order to remove the dependence of the likelihood on the nuisance parameters, $\bm{\theta}$, the nuisance parameter vaues are set to those at which
the likelihood attains it maximum for a given set of $n^{\rm{obs}}_{I}$. This is 
...
used in searches for new physics, see Refs~\ref{CowanPDGProb,0954-3899-45-3-033001}}. 
