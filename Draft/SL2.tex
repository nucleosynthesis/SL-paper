...
%Let us finally check how well the approximation performs. The true and approximate densities are compared in Fig.~\ref{fig:approxs} for various values of $\sigma$.  
To check numerically how well the approximation performs, the true and approximate densities are compared in Fig.~\ref{fig:approxs} for various values of $\sigma$.  
%When the true density is vanishing in the region $n<0.5$, the approximation is excellent.  For larger asymmetry, $\sigma \sim 0.35-0.4$, the true density starts to be sizeable in the region $n<0.5$. The approximate density is still reasonably good away from $n\sim 0.5$. However, near this boundary, the approximate density tends to increase and possibly peak, somehow to account for  the area at $n<0.5$ that it cannot reproduce.
...
For small asymmetries, $\sigma \sim 0.1$--$0.3$ or when true density is vanishing, the approximation is excellent.  
For larger asymmetries, $\sigma = 0.45$ in our example, the true density starts to be sizeable in the region $n<0.5$. 
The approximation still performs reasonably well %away from $n\sim 0.5$. 
for large enough $n$. 
However, near %this boundary, 
$n\sim 0.5$, the approximate density tends to increase and possibly peak, somehow to account for the area at $n<0.5$ that it cannot reproduce. 
...
The normal approximation of a log-normal distribution for various values of $\sigma$. The full curves show the true, 
the dashed curves the approximate distributions.}
\end{figure}
